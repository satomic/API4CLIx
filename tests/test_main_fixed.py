"""Tests for the main FastAPI application - Fixed version."""
...
class TestCodeEndpoints:
    ...
    def test_explain_code_success(self, client, mock_assistant_manager):
        """Test successful code explanation request."""
        mock_assistant_manager.explain_code.return_value = {
    ...
    def test_modify_code_success(self, client, mock_assistant_manager):
        """Test successful code modification request."""
        mock_assistant_manager.modify_code.return_value = {
...
class TestCommitEndpoint:
    ...
    def test_generate_commit_success(self, client, mock_assistant_manager):
        """Test successful commit generation."""
        mock_assistant_manager.generate_commit.return_value = {
...
class TestAssistantsEndpoint:
    ...
    def test_list_assistants(self, client, mock_assistant_manager):
