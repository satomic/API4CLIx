...
from src.api4clix.adapters.copilot import CopilotAdapter
...
class TestCopilotAdapter:
    ...
    async def test_is_available_success(self, copilot_adapter):
        ...
        with patch.object(copilot_adapter, '_run_command') as mock_run:
            mock_run.side_effect = [
                {"success": True, "stdout": "gh version 2.0.0", "stderr": "", "return_code": 0},
                {"success": True, "stdout": "copilot help", "stderr": "", "return_code": 0}
            ]
    ...
    @pytest.mark.asyncio
    async def test_is_available_gh_not_found(self, copilot_adapter):
        """Test availability check when gh CLI is not available."""
        with patch.object(copilot_adapter, '_run_command') as mock_run:
    ...
    async def test_is_available_copilot_not_installed(self, copilot_adapter):
        """Test availability check when Copilot extension is not installed."""
        with patch.object(copilot_adapter, '_run_command') as mock_run:
            mock_run.side_effect = [
                {"success": True, "stdout": "gh version 2.0.0", "stderr": "", "return_code": 0},
                {"success": False, "stdout": "", "stderr": "extension not found", "return_code": 1}
            ]
    ...
    async def test_chat_success(self, copilot_adapter):
        ...
        with patch.object(copilot_adapter, '_run_command') as mock_run:
            mock_run.return_value = {
                "success": True,
                "stdout": "Suggestion: Here's how you can help with your task...",
                "stderr": "",
                "return_code": 0
            }
    ...
    async def test_explain_code_success(self, copilot_adapter):
        ...
        with patch.object(copilot_adapter, '_run_command') as mock_run:
            mock_run.return_value = {
                "success": True,
                "stdout": "This function prints a greeting message to the console.",
                "stderr": "",
                "return_code": 0
            }
    ...
    def test_parse_copilot_output(self, copilot_adapter):
        ...
        raw_output = """Welcome to GitHub Copilot in the CLI!
Suggestion:
